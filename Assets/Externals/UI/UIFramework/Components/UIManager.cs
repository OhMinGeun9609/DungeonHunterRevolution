...
public class UIManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            hpBar.fillAmount = GetPercentage(player.status.playerCurrentHp, player.status.playerMaxHp);
            mpBar.fillAmount = GetPercentage(player.status.playerCurrentMp, player.status.playerMaxMp);
        }
    }
